  ...
  lambdas <- add_results(
    ...
    c(
      list(n_nodes = test_options$dimensions$n_nodes, 
           ...
           n_stat_units = test_options$dimensions$n_stat_units, 
           NSR = test_options$noise$NSR),
      quantitative_results$lambdas
    ),
    names_columns,
    groups_names = quantitative_results$lambdas$Group
  )
  # rmses
...
## analysis ----
## names
name_aggregation_option_vect <- c("NSR","n_stat_units","n_locs","n_nodes")
name_group_vect <- c("NSR","n_stat_units","n_locs","n_nodes")
...
## scores orthonormality
plots <- plot_overall(
  name_aggregation_option_vect = name_aggregation_option_vect,
  name_group_vect = name_group_vect,
  data_plot = rmses[["scores_orth"]],
  title_vect = paste(
    "Deviation from orthonormality of th scores w.r.t the",
    c("signal-to-noise ratio (NSR)",
      "n_stat_units", "n_locs", "n_nodes")
  ),
  colors = colors,
